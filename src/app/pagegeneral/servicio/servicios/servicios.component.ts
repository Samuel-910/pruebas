...
<div class="mb-0">
  ...
  <button
    ...
    [class]="filtros.categoria === null ? 
      'bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 dark:from-violet-600 dark:via-purple-600 dark:to-indigo-600 text-white shadow-xl shadow-emerald-500/25 dark:shadow-violet-500/25 border-emerald-400 dark:border-violet-400 scale-105' : 
      'bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-emerald-300 dark:hover:border-violet-400 hover:shadow-lg hover:shadow-emerald-100 dark:hover:shadow-violet-900/20'"
    class="group relative px-6 py-3 rounded-2xl transition-all duration-500 ease-out font-semibold whitespace-nowrap border-2 backdrop-blur-sm hover:scale-105 transform hover:-translate-y-1 flex items-center min-h-[3rem] overflow-hidden"
  >
    <!-- Efecto de brillo en hover -->
    <div class="absolute inset-0 opacity-0 group-hover:opacity-20 dark:group-hover:opacity-30 bg-gradient-to-r from-transparent via-white to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-all duration-700"></div>
    
    <!-- Icono mejorado para "Todas las categorías" -->
    <div class="relative mr-3 p-1.5 rounded-xl bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-violet-500/20 dark:to-indigo-500/20 group-hover:scale-110 transition-transform duration-300">
      <svg class="w-5 h-5 text-emerald-600 dark:text-violet-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
      </svg>
    </div>
    
    <span class="relative z-10 font-bold tracking-wide">Todas las categorías</span>
    
    <!-- Badge mejorado con animación -->
    <div class="relative ml-3 flex items-center">
      <span 
        [class]="filtros.categoria === null ? 'bg-white/25 text-white border-white/30' : 'bg-gradient-to-r from-emerald-500 to-teal-500 dark:from-violet-500 dark:to-indigo-500 text-white border-emerald-200 dark:border-violet-300'"
        class="inline-flex items-center justify-center min-w-[2rem] h-7 px-2.5 text-xs font-bold rounded-full border backdrop-blur-sm transition-all duration-300 group-hover:scale-110"
      >
        {{ servicios().length }}
      </span>
      <!-- Efecto de pulso para el badge activo -->
      <div *ngIf="filtros.categoria === null" class="absolute inset-0 rounded-full bg-white/20 animate-ping"></div>
    </div>
  </button>
  ...
  <button
    *ngFor="let categoria of categorias()"
    ...
    [class]="filtros.categoria === categoria.id ? 
      'bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 dark:from-blue-500 dark:via-indigo-500 dark:to-purple-600 text-white shadow-xl shadow-orange-500/25 dark:shadow-blue-500/25 border-orange-400 dark:border-blue-400 scale-105' : 
      'bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-700 border-gray-200 dark:border-gray-600 hover:border-orange-300 dark:hover:border-blue-400 hover:shadow-lg hover:shadow-orange-100 dark:hover:shadow-blue-900/20'"
    class="group relative px-5 py-3 rounded-2xl transition-all duration-500 ease-out font-semibold whitespace-nowrap border-2 backdrop-blur-sm hover:scale-105 transform hover:-translate-y-1 flex items-center min-h-[3rem] overflow-hidden"
  >
    <!-- Efecto de brillo en hover -->
    <div class="absolute inset-0 opacity-0 group-hover:opacity-20 dark:group-hover:opacity-30 bg-gradient-to-r from-transparent via-white to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-all duration-700"></div>
    
    <!-- Contenedor del icono mejorado -->
    <div class="relative mr-3 p-1.5 rounded-xl bg-gradient-to-br from-orange-100 to-red-100 dark:from-blue-500/20 dark:to-purple-500/20 group-hover:scale-110 transition-transform duration-300">
      
      <!-- Iconos dinámicos con mejor diseño -->
      <ng-container [ngSwitch]="getIconoCategoria(categoria.nombre)">
        
        <!-- Hospedaje/Hoteles -->
        <svg *ngSwitchCase="'hospedaje'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
        </svg>
        
        <!-- Hoteles -->
        <svg *ngSwitchCase="'hoteles'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
        </svg>
        
        <!-- Alimentos/Restaurantes -->
        <svg *ngSwitchCase="'alimentos'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Restaurantes -->
        <svg *ngSwitchCase="'restaurantes'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4"></path>
        </svg>
        
        <!-- Guías Turísticos -->
        <svg *ngSwitchCase="'guias'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
        </svg>
        
        <!-- Tours -->
        <svg *ngSwitchCase="'tours'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
        </svg>
        
        <!-- Transporte -->
        <svg *ngSwitchCase="'transporte'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <svg *ngSwitchCase="'actividades'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h.01M19 10c0 7-3 13-7 13s-7-6-7-13a7 7 0 0114 0z"></path>
        </svg>
        
        <!-- Entretenimiento -->
        <svg *ngSwitchCase="'entretenimiento'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Aventura -->
        <svg *ngSwitchCase="'aventura'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Cultura -->
        <svg *ngSwitchCase="'cultura'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H15"></path>
        </svg>
        
        <!-- Naturaleza -->
        <svg *ngSwitchCase="'naturaleza'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path>
        </svg>
        
        <!-- Compras/Shopping -->
        <svg *ngSwitchCase="'compras'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
        </svg>
        
        <!-- Eventos -->
        <svg *ngSwitchCase="'eventos'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
        </svg>
        
        <!-- Spa/Bienestar -->
        <svg *ngSwitchCase="'spa'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
        </svg>
        
        <!-- Deportes -->
        <svg *ngSwitchCase="'deportes'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
        </svg>
        
        <!-- Turismo Rural -->
        <svg *ngSwitchCase="'rural'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
        </svg>
        
        <!-- Fotografía Turística -->
        <svg *ngSwitchCase="'fotografia'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9zM15 13a3 3 0 11-6 0 3 3 0 016 0z"></path>
        </svg>
        
        <!-- Servicios Turísticos -->
        <svg *ngSwitchCase="'servicios'" class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V9a2 2 0 01-2 2H8a2 2 0 01-2-2V6m8 0H8m0 0v.01M8 6v6h8V6m-8 6v.01M16 12v.01"></path>
        </svg>
        
        <!-- Icono por defecto -->
        <svg *ngSwitchDefault class="w-5 h-5 text-orange-600 dark:text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <span class="relative z-10 font-bold tracking-wide">{{ categoria.nombre }}</span>
    
    <!-- Badge mejorado con animación -->
    <div class="relative ml-3 flex items-center">
      <span 
        [class]="filtros.categoria === categoria.id ? 'bg-white/25 text-white border-white/30' : 'bg-gradient-to-r from-orange-500 to-red-500 dark:from-blue-500 dark:to-purple-500 text-white border-orange-200 dark:border-blue-300'"
        class="inline-flex items-center justify-center min-w-[2rem] h-7 px-2.5 text-xs font-bold rounded-full border backdrop-blur-sm transition-all duration-300 group-hover:scale-110"
      >
        {{ contarServiciosPorCategoria(categoria.id) }}
      </span>
      <!-- Efecto de pulso para el badge activo -->
      <div *ngIf="filtros.categoria === categoria.id" class="absolute inset-0 rounded-full bg-white/20 animate-ping"></div>
    </div>
  </button>
</div>
</div>
        ...
        >
          <div class="p-4 space-y-6">
            ...
            <div class="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-600">
              ...
              >
                <ng-container *ngIf="!aplicandoFiltros(); else loading">
